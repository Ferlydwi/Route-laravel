...
@section('content')
    <div class="content mt-3">
        <figure class="figure">
            ...
            <img width="200" height="200" src="{{ asset('style/images/6.jpg') }}" class="img-thumbnail" alt="Hallo">
   ...
   <div class="content mt-3">
        <figure class="figure">
            <img width="200" height="200" src="{{ asset('style/images/7.jpg') }}" class="img-thumbnail" alt="Hallo">
            <img width="200" height="200" src="{{ asset('style/images/8.jpg') }}" class="img-thumbnail" alt="Hallo">
